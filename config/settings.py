...
# SMTP — domen pochtasi (aHost va h.k.). Qiymatlar .env dan.
# Port 465 -> SSL (EMAIL_USE_SSL=True), Port 587 -> TLS (EMAIL_USE_TLS=True).
EMAIL_HOST = os.getenv('EMAIL_HOST', 'smtp.gmail.com')
EMAIL_PORT = int(os.getenv('EMAIL_PORT', 587))
EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'False').lower() == 'true'
EMAIL_USE_SSL = os.getenv('EMAIL_USE_SSL', 'True').lower() == 'true'
# Django ikkalasi bir vaqtda True bo'lsa ishga tushmaydi — TLS ni ustun qo'yamiz.
if EMAIL_USE_TLS and EMAIL_USE_SSL:
    EMAIL_USE_SSL = False
EMAIL_TIMEOUT = int(os.getenv('EMAIL_TIMEOUT', 20))   # SMTP osilib qolmasligi uchun
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')
# From — SMTP mailbox bilan bir xil domen bo'lishi shart (aks holda server rad etadi/SPF).
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@solunatravel.uz')
